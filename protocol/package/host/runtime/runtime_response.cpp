...
struct axcl::pkg::host::runtime_response::impl {
...
private:
    axcl::runtime::response::Payload* m_payload = {nullptr};
};

axcl::pkg::host::runtime_response::runtime_response() : m_impl(new impl()) {
}

axcl::pkg::host::runtime_response::runtime_response(runtime_response&& other) noexcept : m_impl(std::exchange(other.m_impl, nullptr)) {
}

axcl::pkg::host::runtime_response& axcl::pkg::host::runtime_response::operator=(runtime_response&& other) noexcept {
    if (this != &other) {
        delete m_impl;
...
axcl::pkg::host::runtime_response::~runtime_response() {
    delete m_impl;
}

[[nodiscard]] bool axcl::pkg::host::runtime_response::decode(const void* message, uint32_t size) const {
...
axcl::pkg::runtime::module axcl::pkg::host::runtime_response::get_module() const {
    return m_impl->get_module();
}

void* axcl::pkg::host::runtime_response::get_payload() const {
