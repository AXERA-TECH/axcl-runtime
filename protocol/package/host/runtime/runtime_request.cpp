...
struct axcl::pkg::host::runtime_request::impl {
    impl() = delete;

    explicit impl(void* payload) : m_payload(static_cast<axcl::runtime::request::Payload*>(payload)) {
...
private:
    axcl::runtime::request::Payload* m_payload;
};

axcl::pkg::host::runtime_request::runtime_request() : m_impl(new impl(request::select(axcl::pkg::module::RUNTIME))) {
}

axcl::pkg::host::runtime_request::runtime_request(runtime_request&& other) noexcept
    : request(std::move(other)), m_impl(std::exchange(other.m_impl, nullptr)) {
}

axcl::pkg::host::runtime_request& axcl::pkg::host::runtime_request::operator=(runtime_request&& other) noexcept {
    if (this != &other) {
        delete m_impl;
...
axcl::pkg::host::runtime_request::~runtime_request() {
    delete m_impl;
}

[[nodiscard]] void* axcl::pkg::host::runtime_request::select(const axcl::pkg::runtime::module& module) const {
