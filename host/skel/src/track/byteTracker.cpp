...
CBYTETracker::CBYTETracker(const AX_U32& n_classes, const AX_U32& frame_rate, const AX_U32& track_buffer, const float& high_det_thresh,
...
track_map<AX_U32, vector<CTrack>> CBYTETracker::update(const AX_U32 &nStreamId, const AX_U64 &nFrameId, const vector<Object>& objects) {
    // frame id updating
    this->m_frame_id++;
