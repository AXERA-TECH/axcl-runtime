...
AX_S32 SAMPLE_COMM_IVE_CreateImage(AX_IVE_IMAGE_T* pstImg, AX_IVE_IMAGE_TYPE_E enType, AX_U32 u32Width, AX_U32 u32Height)
{
    ...
    case AX_IVE_IMAGE_TYPE_S8C1:
        ...
        if (s32Ret != AX_SUCCESS) {
            SAMPLE_IVE_PRT("Device Cmm Alloc fail,Error(%#x)\n", s32Ret);
            return s32Ret;
        }
        s32Ret = axclrtMallocHost((AX_VOID **)&pstImg->au64VirAddr[0], u32Size);
        if (s32Ret != AX_SUCCESS) {
            SAMPLE_IVE_PRT("Host Cmm Alloc fail,Error(%#x)\n", s32Ret);
            return s32Ret;
        }
        break;
...
AX_S32 SAMPLE_COMM_IVE_CreateMemInfo(AX_IVE_MEM_INFO_T* pstMemInfo, AX_U32 u32Size)
{
    ...
    s32Ret = axclrtMalloc((AX_VOID **)&pstMemInfo->u64PhyAddr, u32Size, AXCL_MEM_MALLOC_NORMAL_ONLY);
    if (s32Ret != AX_SUCCESS) {
        SAMPLE_IVE_PRT("Cmm Alloc fail,Error(%#x)\n", s32Ret);
        return AX_FAILURE;
    }
    s32Ret = axclrtMallocHost((AX_VOID **)&pstMemInfo->u64VirAddr, ALIGN_UP(u32Size, 4096));
    if (s32Ret != AX_SUCCESS) {
        SAMPLE_IVE_PRT("Host Cmm Alloc fail,Error(%#x)\n", s32Ret);
        return s32Ret;
    }
...
AX_S32 SAMPLE_COMM_IVE_CreateMemInfoHost(AX_IVE_MEM_INFO_T* pstMemInfo, AX_U32 u32Size)
{
    AX_S32 s32Ret;
    if (NULL == pstMemInfo) {
        SAMPLE_IVE_PRT("pstMemInfo is null\n");
...
AX_S32 SAMPLE_COMM_IVE_ReadFile(AX_IVE_IMAGE_T* pstImg, FILE* pFp)
{
    ...
    case AX_IVE_IMAGE_TYPE_U8C1:
        fileSZ = pstImg->au32Stride[0] * pstImg->u32Height;
        ...
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], fileSZ, AXCL_MEMCPY_HOST_TO_DEVICE);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy host memory %p to device memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], s32Ret);
             return s32Ret;
        }
        break;
    case  AX_IVE_IMAGE_TYPE_YUV420SP:
        ...
        fileSZ = pstImg->au32Stride[1] * pstImg->u32Height;
        ...
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64PhyAddr[1], (AX_VOID *)pstImg->au64VirAddr[1], fileSZ, AXCL_MEMCPY_HOST_TO_DEVICE);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy host memory %p to device memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64VirAddr[1], (AX_VOID *)pstImg->au64PhyAddr[1], s32Ret);
             return s32Ret;
        }
        break;
    case AX_IVE_IMAGE_TYPE_YUV422SP:
    ...
    case AX_IVE_IMAGE_TYPE_U8C3_PLANAR:
        for (loop = 0; loop < 3; loop++) {
            ...
            fileSZ = pstImg->au32Stride[loop] * pstImg->u32Height;
            s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64PhyAddr[loop], (AX_VOID *)pstImg->au64VirAddr[loop], fileSZ, AXCL_MEMCPY_HOST_TO_DEVICE);
            if (s32Ret) {
                 SAMPLE_IVE_PRT("memcpy host memory %p to device memory %p fail, ret = 0x%x\n",
                                (AX_VOID *)pstImg->au64VirAddr[loop], (AX_VOID *)pstImg->au64PhyAddr[loop], s32Ret);
                 return s32Ret;
            }
        }
        break;
    ...
    case AX_IVE_IMAGE_TYPE_U16C1:
        ...
        fileSZ = pstImg->au32Stride[0] * 2 * pstImg->u32Height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], fileSZ, AXCL_MEMCPY_HOST_TO_DEVICE);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy host memory %p to device memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], s32Ret);
...
AX_S32 SAMPLE_COMM_IVE_WriteFile(AX_IVE_IMAGE_T* pstImg, FILE* pFp)
{
    ...
    case AX_IVE_IMAGE_TYPE_U8C1:
    case AX_IVE_IMAGE_TYPE_S8C1:
        fileSZ = pstImg->au32Stride[0] * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], s32Ret);
             return s32Ret;
        }
        pU8 = (AX_U8 *)(AX_UL)pstImg->au64VirAddr[0];
        for (y = 0; y < height; y++) {
    ...
    case AX_IVE_IMAGE_TYPE_YUV420SP:
        ...
        fileSZ = pstImg->au32Stride[1] * height / 2;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[1], (AX_VOID *)pstImg->au64PhyAddr[1], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[1], (AX_VOID *)pstImg->au64VirAddr[1], s32Ret);
             return s32Ret;
        }
        pU8 = (AX_U8 *)(AX_UL)pstImg->au64VirAddr[1];
        for (y = 0; y < height / 2; y++) {
    ...
    case AX_IVE_IMAGE_TYPE_YUV422SP:
        ...
        fileSZ = pstImg->au32Stride[1] * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[1], (AX_VOID *)pstImg->au64PhyAddr[1], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[1], (AX_VOID *)pstImg->au64VirAddr[1], s32Ret);
    ...
    case AX_IVE_IMAGE_TYPE_S16C1:
    case AX_IVE_IMAGE_TYPE_U16C1:
        fileSZ = pstImg->au32Stride[0] * 2 * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], s32Ret);
        ...
        break;
    case AX_IVE_IMAGE_TYPE_U32C1:
        fileSZ = pstImg->au32Stride[0] * 4 * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], s32Ret);
        ...
        break;
    case AX_IVE_IMAGE_TYPE_U64C1:
        fileSZ = pstImg->au32Stride[0] * 8 * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], s32Ret);
        ...
        break;
    case AX_IVE_IMAGE_TYPE_U8C3_PACKAGE:
        fileSZ = pstImg->au32Stride[0] * 3 * height;
        s32Ret = axclrtMemcpy((AX_VOID *)pstImg->au64VirAddr[0], (AX_VOID *)pstImg->au64PhyAddr[0], fileSZ, AXCL_MEMCPY_DEVICE_TO_HOST);
        if (s32Ret) {
             SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                            (AX_VOID *)pstImg->au64PhyAddr[0], (AX_VOID *)pstImg->au64VirAddr[0], s32Ret);
...
AX_S32 SAMPLE_COMM_IVE_WriteFileHost(AX_IVE_IMAGE_T* pstImg, FILE* pFp)
{
    AX_U16 y;
    AX_U8* pU8;
    AX_U16 height;
...
AX_S32 SAMPLE_COMM_IVE_ReadMemInfoFile(AX_IVE_SRC_MEM_INFO_T* pstMemInfo, FILE* pFp)
{
    ...
    s32Ret = axclrtMemcpy((AX_VOID *)pstMemInfo->u64PhyAddr, (AX_VOID *)pstMemInfo->u64VirAddr, size, AXCL_MEMCPY_HOST_TO_DEVICE);
    if (s32Ret) {
         SAMPLE_IVE_PRT("memcpy host memory %p to device memory %p fail, ret = 0x%x\n",
                        (AX_VOID *)pstMemInfo->u64VirAddr, (AX_VOID *)pstMemInfo->u64PhyAddr, s32Ret);
         return s32Ret;
    }
    return AX_SUCCESS;
}
...
AX_S32 SAMPLE_COMM_IVE_WriteMemInfoFile(AX_IVE_DST_MEM_INFO_T* pstMemInfo, FILE* pFp)
{
    ...
    s32Ret = axclrtMemcpy((AX_VOID *)pstMemInfo->u64VirAddr, (AX_VOID *)pstMemInfo->u64PhyAddr, size, AXCL_MEMCPY_DEVICE_TO_HOST);
    if (s32Ret) {
        SAMPLE_IVE_PRT("memcpy device memory %p to host memory %p fail, ret = 0x%x\n",
                        (AX_VOID *)pstMemInfo->u64VirAddr, (AX_VOID *)pstMemInfo->u64PhyAddr, s32Ret);
        return AX_FAILURE;
...
AX_S32 SAMPLE_COMM_IVE_WriteMemInfoFileHost(AX_IVE_DST_MEM_INFO_T* pstMemInfo, FILE* pFp)
{
    AX_U8* pU8;
    AX_U32 size = pstMemInfo->u32Size;
    pU8 = (AX_U8 *)(AX_UL)pstMemInfo->u64VirAddr;
...
AX_S32 SAMPLE_COMM_IVE_CreateImage_WithGlbImgFmt(AX_IVE_IMAGE_T* pstImg, AX_IMG_FORMAT_E enType, AX_U32 u32Width, AX_U32 u32Height)
{
    ...
    case AX_FORMAT_BITMAP:
        ...
        s32Ret = axclrtMallocHost((AX_VOID **)&pstImg->au64VirAddr[0], ALIGN_UP(u32Size, 4096));
        if (s32Ret != AX_SUCCESS) {
            SAMPLE_IVE_PRT("Host Cmm Alloc fail,Error(%#x)\n", s32Ret);
            return s32Ret;
        }
...
AX_S32 SAMPLE_COMM_IVE_WriteFile_WithGlbImgFmtHost(AX_IVE_IMAGE_T* pstImg, FILE* pFp)
{
    AX_U16 y;
    AX_U8* pU8;
    AX_U16 height;
