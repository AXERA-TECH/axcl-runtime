...
static AX_S32 SAMPLE_IVE_TestDualPicCalcProc(TEST_DUALPIC_CALC_T* pstTestDualPic, AX_U32 u32Mode)
{
    ...
    switch(u32Mode) {
        case 0:
            s32Ret = AXCL_IVE_Add(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, &pstTestDualPic->stAddCtrl, bInstant);
            if (AX_SUCCESS != s32Ret) {
            ...
            break;
        case 1:
            s32Ret = AXCL_IVE_Sub(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, &pstTestDualPic->stSubCtrl, bInstant);
            if (AX_SUCCESS != s32Ret) {
            ...
            break;
        case 2:
            s32Ret = AXCL_IVE_And(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, bInstant);
            if (AX_SUCCESS != s32Ret) {
            ...
            break;
        case 3:
            s32Ret = AXCL_IVE_Or(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, bInstant);
            if (AX_SUCCESS != s32Ret) {
            ...
            break;
        case 4:
            s32Ret = AXCL_IVE_Xor(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, bInstant);
            if (AX_SUCCESS != s32Ret) {
            ...
            break;
        case 5:
            s32Ret = AXCL_IVE_Mse(&IveHandle, &pstTestDualPic->stSrc1, &pstTestDualPic->stSrc2, &pstTestDualPic->stDst, &pstTestDualPic->stMseCtrl, bInstant);
            if (AX_SUCCESS != s32Ret) {
