...
protected:
    RuntimeTest(axcl::pkg::runtime::module mod) {
        m_head_type = CREATE_PACKAGE_HEAD_TYPE(axcl::pkg::PROTO, axcl::pkg::module::RUNTIME, mod, 0);
    }
...
template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
axcl::randomizer RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::m_random;

template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
REQ_ENC RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::m_req_encode;

template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
REQ_DEC RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::m_req_decode;

template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
RSP_ENC RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::m_ack_encode;

template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
RSP_DEC RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::m_ack_decode;

template <typename REQ_ENC, typename REQ_DEC, typename RSP_ENC, typename RSP_DEC>
axcl::pkg::version RuntimeTest<REQ_ENC, REQ_DEC, RSP_ENC, RSP_DEC>::PROTOCOL_VERSION = {
