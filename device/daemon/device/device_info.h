...
#define DEV_HEARTBEATS_PORT (10)
#define DEV_PORTALLOCATE_PORT (11)
#define DEV_TELEMETRY_PORT  (12)

#define DEV_HEARTBEATS_INTERVAL (9000)
#define DEV_HEARTBEATS_SLEEP    (3000)

#define DEV_PATH "/dev/axcl_device"
